...
# -*- coding: utf-8 -*-
"""
Created on Fri Dec 28 21:08:13 2018
...
for idx in range(3, 5): 
    a, b = anomaly_information[idx]
#    print(anomaly_information[])
    
    
#    for idx_seq in range(0, len(df_test_idx)):
#        start_idx = df_test_idx[idx_seq][0]
#        end_idx = df_test_idx[idx_seq][1]
